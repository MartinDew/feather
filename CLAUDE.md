...
- `enable_c_bindings` / `enable_cs_bindings` / `enable_py_bindings` (default on) — generate the mrbind-based C/C#/Python bindings for `core/`. `enable_py_bindings` is ignored on Windows.
